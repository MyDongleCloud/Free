...
static void *wiFiAddActivate_t(void *arg) {
	...
	g_object_set(s_con, NM_SETTING_CONNECTION_ID, "MyDongleCloud", NM_SETTING_CONNECTION_UUID, nm_utils_uuid_generate(), NM_SETTING_CONNECTION_TYPE, NM_SETTING_WIRELESS_SETTING_NAME, NULL);
